...
# 测试之后发现rescale函数会将通道也进行缩放; 个人觉得所不缩放无所谓 ; 所以直接注释掉了
# print(test_image.shape)
# test_image = rescale(test_image, 0.333)
# print(test_image.shape)
...
plt.figure(); plt.imshow(laplacian_image); plt.show();
...
plt.figure(); plt.imshow(high_pass_image);plt.show();
